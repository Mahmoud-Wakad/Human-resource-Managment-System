package com.hrms.leaveattendanceservice.security;
...
public class BearerTokenFilter extends OncePerRequestFilter {
  ...
  protected boolean shouldNotFilter(HttpServletRequest request) {
    ...
    return path.startsWith("/api/leaves/health") || path.startsWith("/api/attendance/health") || path.startsWith("/actuator/") || path.equals("/error") || path.contains("/h2-console");
  }
